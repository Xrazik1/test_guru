...
BadgeRule.create(title: 'За прохождение теста с первой попытки', attempt: 1, attempt_badge: true)
BadgeRule.create(title: 'За прохождение всех тестов из категории Backend', category_id: 2, category_badge: true)
BadgeRule.create(title: 'За прохождение всех тестов 1 уровня сложности', level: 1, level_badge: true)
